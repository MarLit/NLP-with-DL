...
def getSentenceFeatures(tokens, wordVectors, sentence):
    ...
    for word in sentence:
        index = tokens[word] #
        vector_w = wordVectors[index]
        sentence_vector = sentence_vector + vector_w
    
    sentVector = sentence_vector / len(sentence)
    
    ###############################################################################
    #sentVector1 = np.zeros((wordVectors.shape[1],)) ###
    
    #listOfInd = [tokens[w] for w in sentence]
    #for i in listOfInd:
    #	sentVector1 += wordVectors[i]
    #sentVector1 /= len(listOfInd)
    ###############################################################################
    
    #print("Difference:", sentVector - sentVector1) ### -- We get the same results...
...
def getRegularizationValues():
    ...
    #values.extend((10, 1, 0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001, 0.0000001,0))
    values = [100, 10, 1, 0.1, 0.01, 0.001, 0.0001, 0.00001, 0.000001, 0.0000001, 0]
    ### END YOUR CODE
